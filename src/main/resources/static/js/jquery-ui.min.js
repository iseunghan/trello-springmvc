...
!function (t) {
    ...
    b.ui = b.ui || {};
    b.ui.version = "1.12.1";
    var o, i = 0, h = Array.prototype.slice;
    b.cleanData = (o = b.cleanData, function (t) {
        ...
        return e || (e = i, i = b.Widget), b.isArray(e) && (e = b.extend.apply(null, [{}].concat(e))), b.expr[":"][a.toLowerCase()] = function (t) {
            return !!b.data(t, a)
        }, b[h] = b[h] || {}, s = b[h][t], o = b[h][t] = function (t, e) {
            ...
            _proto: b.extend({}, e),
            _childConstructors: []
        }), (n = new i).options = b.widget.extend({}, n.options), b.each(e, function (e, s) {
            function o() {
        ...
        }), o.prototype = b.widget.extend(n, {widgetEventPrefix: s && n.widgetEventPrefix || t}, r, {
            constructor: o,
            namespace: h,
            widgetName: t,
            widgetFullName: a
        ...
        }), delete s._childConstructors) : i._childConstructors.push(o), b.widget.bridge(t, o), o
    }, b.widget.extend = function (t) {
        for (var e, i, s = h.call(arguments, 1), o = 0, n = s.length; o < n; o++) for (e in s[o]) i = s[o][e], s[o].hasOwnProperty(e) && void 0 !== i && (b.isPlainObject(i) ? t[e] = b.isPlainObject(t[e]) ? b.widget.extend({}, t[e], i) : b.widget.extend({}, i) : t[e] = i);
        return t
    }, b.widget.bridge = function (n, e) {
        var r = e.prototype.widgetFullName || n;
        b.fn[n] = function (i) {
            var t = "string" == typeof i, s = h.call(arguments, 1), o = this;
            return t ? this.length || "instance" !== i ? this.each(function () {
                var t, e = b.data(this, r);
                return "instance" === i ? (o = e, !1) : e ? b.isFunction(e[i]) && "_" !== i.charAt(0) ? (t = e[i].apply(e, s)) !== e && void 0 !== t ? (o = t && t.jquery ? o.pushStack(t.get()) : t, !1) : void 0 : b.error("no such method '" + i + "' for " + n + " widget instance") : b.error("cannot call methods on " + n + " prior to initialization; attempted to call method '" + i + "'")
            }) : o = void 0 : (s.length && (i = b.widget.extend.apply(null, [i].concat(s))), this.each(function () {
                var t = b.data(this, r);
        ...
        option: function (t, e) {
            ...
            if ("string" == typeof t) if (n = {}, t = (i = t.split(".")).shift(), i.length) {
                for (s = n[t] = b.widget.extend({}, this.options[t]), o = 0; o < i.length - 1; o++) s[i[o]] = s[i[o]] || {}, s = s[i[o]];
        ...
        _classes: function (o) {
            ...
            function t(t, e) {
                for (var i, s = 0; s < t.length; s++) i = r.classesElementLookup[t[s]] || b(), i = o.add ? b(b.unique(i.get().concat(o.element.get()))) : b(i.not(o.element).get()), r.classesElementLookup[t[s]] = i, n.push(t[s]), e && o.classes[t[s]] && n.push(o.classes[t[s]])
            }
        ...
        _toggleClass: function (t, e, i, s) {
            ...
            var o = "string" == typeof t || null === t,
                t = {extra: o ? e : i, keys: o ? t : e, element: o ? this.element : t, add: s};
        ...
        _on: function (o, n, t) {
            ...
            "boolean" != typeof o && (t = n, n = o, o = !1), t ? (n = r = b(n), this.bindings = this.bindings.add(n)) : (t = n, n = this.element, r = this.widget()), b.each(t, function (t, e) {
                function i() {
                    if (o || !0 !== h.options.disabled && !b(this).hasClass("ui-state-disabled")) return ("string" == typeof e ? h[e] : e).apply(h, arguments)
                }
        ...
        _trigger: function (t, e, i) {
            ...
            if (i = i || {}, (e = b.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), e.target = this.element[0], o = e.originalEvent) for (s in o) s in e || (e[s] = o[s]);
            return this.element.trigger(e, i), !(b.isFunction(n) && !1 === n.apply(this.element[0], [e].concat(i)) || e.isDefaultPrevented())
        }
        ...
        b.Widget.prototype["_" + n] = function (e, t, i) {
            ...
            "number" == typeof (t = t || {}) && (t = {duration: t}), s = !b.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay), s && b.effects && b.effects.effect[o] ? e[n](t) : o !== n && e[o] ? e[o](t.duration, t.easing, i) : e.queue(function (t) {
    ...
    b.widget("ui.draggable", b.ui.mouse, {
        ...
        start: function (e, t, i) {
            ...
            b.each(o.sortables, function () {
                ...
                e.positionAbs = o.positionAbs, e.helperProportions = o.helperProportions, e.offset.click = o.offset.click, e._intersectsWith(e.containerCache) && (t = !0, b.each(o.sortables, function () {
                    ...
                    return s.helper[0]
                }, i.target = e.currentItem[0], e._mouseCapture(i, !0), e._mouseStart(i, !0, !0), e.offset.click.top = o.offset.click.top, e.offset.click.left = o.offset.click.left, e.offset.parent.left -= o.offset.parent.left - e.offset.parent.left, e.offset.parent.top -= o.offset.parent.top - e.offset.parent.top, o._trigger("toSortable", i), o.dropped = e.element, b.each(o.sortables, function () {
                    this.refreshPositions()
                }), o.currentItem = o.element, e.fromOutside = o), e.currentItem && (e._mouseDrag(i), s.position = e.position)) : e.isOver && (e.isOver = 0, e.cancelHelperRemoval = !0, e.options._revert = e.options.revert, e.options.revert = !1, e._trigger("out", i, e._uiHash(e)), e._mouseStop(i, !0), e.options.revert = e.options._revert, e.options.helper = e.options._helper, e.placeholder && e.placeholder.remove(), s.helper.appendTo(o._parent), o._refreshOffsets(i), s.position = o._generatePosition(i, !0), o._trigger("fromSortable", i), o.dropped = !1, b.each(o.sortables, function () {
                    this.refreshPositions()
                }))
            })
        }
        ...
        start: function (t, e, i) {
            ...
            var s = i.options, o = !1, n = i.scrollParentNotHidden[0], r = i.document[0];
        ...
        start: function (t, e, i) {
            ...
            for (var s, o, n, r, h, a, l, c, p, d = i.options, u = d.snapTolerance, f = e.offset.left, g = f + i.helperProportions.width, m = e.offset.top, _ = m + i.helperProportions.height, v = i.snapElements.length - 1; 0 <= v; v--) a = (h = i.snapElements[v].left - i.margins.left) + i.snapElements[v].width, c = (l = i.snapElements[v].top - i.margins.top) + i.snapElements[v].height, g < h - u || a + u < f || _ < l - u || c + u < m || !b.contains(i.snapElements[v].item.ownerDocument, i.snapElements[v].item) ? (i.snapElements[v].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, b.extend(i._uiHash(), {snapItem: i.snapElements[v].item})), i.snapElements[v].snapping = !1) : ("inner" !== d.snapMode && (s = Math.abs(l - _) <= u, o = Math.abs(c - m) <= u, n = Math.abs(h - g) <= u, r = Math.abs(a - f) <= u, s && (e.position.top = i._convertPositionTo("relative", {
                ...
                top: 0,
                left: a
            }).left)), p = s || o || n || r, "outer" !== d.snapMode && (s = Math.abs(l - m) <= u, o = Math.abs(c - _) <= u, n = Math.abs(h - f) <= u, r = Math.abs(a - g) <= u, s && (e.position.top = i._convertPositionTo("relative", {
                top: l,
                left: 0
            }).top), o && (e.position.top = i._convertPositionTo("relative", {
            ...
            }).left)), !i.snapElements[v].snapping && (s || o || n || r || p) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, b.extend(i._uiHash(), {snapItem: i.snapElements[v].item})), i.snapElements[v].snapping = s || o || n || r || p)
        }
    ...
    var r = b.ui.intersect = function (t, e, i, s) {
        ...
        var o = (t.positionAbs || t.position.absolute).left + t.margins.left,
            ...
            h = n + t.helperProportions.height, a = e.offset.left, l = e.offset.top, c = a + e.proportions().width,
        ...
        switch (i) {
            ...
            case"pointer":
                return d(s.pageY, l, e.proportions().height) && d(s.pageX, a, e.proportions().width);
            case"touch":
    ...
    !(b.ui.ddmanager = {
        current: null, droppables: {default: []}, prepareOffsets: function (t, e) {
            var i, s, o = b.ui.ddmanager.droppables[t.options.scope] || [], n = e ? e.type : null,
                r = (t.currentItem || t.element).find(":data(ui-droppable)").addBack();
            t:for (i = 0; i < o.length; i++) if (!(o[i].options.disabled || t && !o[i].accept.call(o[i].element[0], t.currentItem || t.element))) {
                for (s = 0; s < r.length; s++) if (r[s] === o[i].element[0]) {
            ...
            o.options.refreshPositions && b.ui.ddmanager.prepareOffsets(o, n), b.each(b.ui.ddmanager.droppables[o.options.scope] || [], function () {
                var t, e, i, s;
                this.options.disabled || this.greedyChild || !this.visible || (s = !(i = r(o, this, this.options.tolerance, n)) && this.isover ? "isout" : i && !this.isover ? "isover" : null) && (this.options.greedy && (e = this.options.scope, (i = this.element.parents(":data(ui-droppable)").filter(function () {
                    return b(this).droppable("instance").options.scope === e
                })).length && ((t = b(i[0]).droppable("instance")).greedyChild = "isover" === s)), t && "isover" === s && (t.isover = !1, t.isout = !0, t._out.call(t, n)), this[s] = !0, this["isout" === s ? "isover" : "isout"] = !1, this["isover" === s ? "_over" : "_out"].call(this, n), t && "isout" === s && (t.isout = !1, t.isover = !0, t._over.call(t, n)))
            })
    ...
    b.widget("ui.resizable", b.ui.mouse, {
        ...
        _setupHandles: function () {
            ...
            if (this.handles = n.handles || (b(".ui-resizable-handle", this.element).length ? {
                ...
                ne: ".ui-resizable-ne",
                nw: ".ui-resizable-nw"
            } : "e,s,se"), this._handles = b(), this.handles.constructor === String) for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), i = this.handles.split(","), this.handles = {}, e = 0; e < i.length; e++) s = "ui-resizable-" + (t = b.trim(i[e])), o = b("<div>"), this._addClass(o, "ui-resizable-handle " + s), o.css({zIndex: n.zIndex}), this.handles[t] = ".ui-resizable-" + t, this.element.append(o);
        ...
        _mouseStop: function (t) {
            ...
            }, i = parseFloat(n.element.css("left")) + (n.position.left - n.originalPosition.left) || null, s = parseFloat(n.element.css("top")) + (n.position.top - n.originalPosition.top) || null, o.animate || this.element.css(b.extend(e, {
                top: s,
                left: i
            })), n.helper.height(n.size.height), n.helper.width(n.size.width), this._helper && !o.animate && this._proportionallyResize()), b("body").css("cursor", "auto"), this._removeClass("ui-resizable-resizing"), this._propagate("stop", t), this._helper && this.helper.remove(), !1
        },
        ...
        stop: function (e) {
            var i = b(this).resizable("instance"), t = i.options, s = i._proportionallyResizeElements,
                ...
                n = o && i._hasScroll(s[0], "left") ? 0 : i.sizeDiff.height, r = o ? 0 : i.sizeDiff.width,
        ...
        start: function () {
            var i, s, o = b(this).resizable("instance"), t = o.options, e = o.element, n = t.containment,
                r = n instanceof b ? n.get(0) : /parent/.test(n) ? e.parent().get(0) : n;
            r && (o.containerElement = b(r), /document/.test(n) || n === document ? (o.containerOffset = {
                left: 0,
                top: 0
            }, o.containerPosition = {left: 0, top: 0}, o.parentData = {
                element: b(document),
                left: 0,
                top: 0,
            ...
            var e = b(this).resizable("instance"), i = e.options, s = e.containerOffset, o = e.position,
                n = e._aspectRatio || t.shiftKey, r = {top: 0, left: 0}, h = e.containerElement, t = !0;
            ...
            var t = b(this).resizable("instance"), e = t.options, i = t.containerOffset, s = t.containerPosition,
                o = t.containerElement, n = b(t.helper), r = n.offset(), h = n.outerWidth() - t.sizeDiff.width,
        ...
        start: function () {
            ...
            var e = b(this).resizable("instance"), s = e.options, o = e.originalSize, n = e.originalPosition, r = {
            ...
            b(s.alsoResize).each(function () {
                var t = b(this), s = b(this).data("ui-resizable-alsoresize"), o = {},
        ...
        resize: function () {
            var t, e = b(this).resizable("instance"), i = e.options, s = e.size, o = e.originalSize,
                n = e.originalPosition, r = e.axis, h = "number" == typeof i.grid ? [i.grid, i.grid] : i.grid,
                a = h[0] || 1, l = h[1] || 1, c = Math.round((s.width - o.width) / a) * a,
                p = Math.round((s.height - o.height) / l) * l, d = o.width + c, u = o.height + p,
                f = i.maxWidth && i.maxWidth < d, g = i.maxHeight && i.maxHeight < u, m = i.minWidth && i.minWidth > d,
                s = i.minHeight && i.minHeight > u;
            i.grid = h, m && (d += a), s && (u += l), f && (d -= a), g && (u -= l), /^(se|s|e)$/.test(r) ? (e.size.width = d, e.size.height = u) : /^(ne)$/.test(r) ? (e.size.width = d, e.size.height = u, e.position.top = n.top - p) : /^(sw)$/.test(r) ? (e.size.width = d, e.size.height = u, e.position.left = n.left - c) : ((u - l <= 0 || d - a <= 0) && (t = e._getPaddingPlusBorderDimensions(this)), 0 < u - l ? (e.size.height = u, e.position.top = n.top - p) : (u = l - t.height, e.size.height = u, e.position.top = n.top + o.height - u), 0 < d - a ? (e.size.width = d, e.position.left = n.left - c) : (d = a - t.width, e.size.width = d, e.position.left = n.left + o.width - d))
        }
    });
    b.ui.resizable, b.widget("ui.selectable", b.ui.mouse, {
        ...
        _mouseDrag: function (s) {
            if (this.dragged = !0, !this.options.disabled) {
                var t, o = this, n = this.options, r = this.opos[0], h = this.opos[1], a = s.pageX, l = s.pageY;
        ...
        _mouseCapture: function (t, e) {
            ...
            return !this.reverting && (!this.options.disabled && "static" !== this.options.type && (this._refreshItems(t), b(t.target).parents().each(function () {
                if (b.data(this, o.widgetName + "-item") === o) return i = b(this), !1
            }), b.data(t.target, o.widgetName + "-item") === o && (i = b(t.target)), !!i && (!(this.options.handle && !e && (b(this.options.handle, i).find("*").addBack().each(function () {
                this === t.target && (s = !0)
        ...
        _mouseStart: function (t, e, i) {
            ...
            return b.ui.ddmanager && (b.ui.ddmanager.current = this), b.ui.ddmanager && !n.dropBehaviour && b.ui.ddmanager.prepareOffsets(this, t), this.dragging = !0, this._addClass(this.helper, "ui-sortable-helper"), this._mouseDrag(t), !0
        },
        _mouseDrag: function (t) {
        ...
        _mouseStop: function (t, e) {
            var i, s, o, n;
            if (t) return b.ui.ddmanager && !this.options.dropBehaviour && b.ui.ddmanager.drop(this, t), this.options.revert ? (s = (i = this).placeholder.offset(), n = {}, (o = this.options.axis) && "x" !== o || (n.left = s.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollLeft)), o && "y" !== o || (n.top = s.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollTop)), this.reverting = !0, b(this.helper).animate(n, parseInt(this.options.revert, 10) || 500, function () {
                i._clear(t)
            })) : this._clear(t, e), !1
        },
        cancel: function () {
        ...
        _intersectsWith: function (t) {
            var e = this.positionAbs.left, i = e + this.helperProportions.width, s = this.positionAbs.top,
                o = s + this.helperProportions.height, n = t.left, r = n + t.width, h = t.top, a = h + t.height,
                l = this.offset.click.top, c = this.offset.click.left,
                l = "x" === this.options.axis || h < s + l && s + l < a,
                c = "y" === this.options.axis || n < e + c && e + c < r, c = l && c;
        ...
        _getItemsAsjQuery: function (t) {
            var e, i, s, o, n = [], r = [], h = this._connectWith();
            if (h && t) for (e = h.length - 1; 0 <= e; e--) for (i = (s = b(h[e], this.document[0])).length - 1; 0 <= i; i--) (o = b.data(s[i], this.widgetFullName)) && o !== this && !o.options.disabled && r.push([b.isFunction(o.options.items) ? o.options.items.call(o.element) : b(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
        ...
        _refreshItems: function (t) {
            ...
            var e, i, s, o, n, r, h, a, l = this.items,
                ...
                p = this._connectWith();
            if (p && this.ready) for (e = p.length - 1; 0 <= e; e--) for (i = (s = b(p[e], this.document[0])).length - 1; 0 <= i; i--) (o = b.data(s[i], this.widgetFullName)) && o !== this && !o.options.disabled && (c.push([b.isFunction(o.options.items) ? o.options.items.call(o.element[0], t, {item: this.currentItem}) : b(o.options.items, o.element), o]), this.containers.push(o));
            for (e = c.length - 1; 0 <= e; e--) for (n = c[e][1], i = 0, a = (r = c[e][0]).length; i < a; i++) (h = b(r[i])).data(this.widgetName + "-item", n), l.push({
                item: h,
                instance: n,
                width: 0,
                height: 0,
        ...
        refreshPositions: function (t) {
            var e, i, s, o;
            for (this.floating = !!this.items.length && ("x" === this.options.axis || this._isFloating(this.items[0].item)), this.offsetParent && this.helper && (this.offset.parent = this._getParentOffset()), e = this.items.length - 1; 0 <= e; e--) (i = this.items[e]).instance !== this.currentContainer && this.currentContainer && i.item[0] !== this.currentItem[0] || (s = this.options.toleranceElement ? b(this.options.toleranceElement, i.item) : i.item, t || (i.width = s.outerWidth(), i.height = s.outerHeight()), o = s.offset(), i.left = o.left, i.top = o.top);
        ...
        _createPlaceholder: function (i) {
            ...
            }), i.placeholder = b(o.placeholder.element.call(i.element, i.currentItem)), i.currentItem.after(i.placeholder), o.placeholder.update(i, i.placeholder)
        },
        ...
        _contactContainers: function (t) {
            ...
            if (c) if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger("over", t, this._uiHash(this)), this.containers[p].containerCache.over = 1); else {
                for (i = 1e4, s = null, o = (a = c.floating || this._isFloating(this.currentItem)) ? "left" : "top", n = a ? "width" : "height", l = a ? "pageX" : "pageY", e = this.items.length - 1; 0 <= e; e--) b.contains(this.containers[p].element[0], this.items[e].item[0]) && this.items[e].item[0] !== this.currentItem[0] && (r = this.items[e].item.offset()[o], h = !1, t[l] - r > this.items[e][n] / 2 && (h = !0), Math.abs(t[l] - r) < i && (i = Math.abs(t[l] - r), s = this.items[e], this.direction = h ? "up" : "down"));
